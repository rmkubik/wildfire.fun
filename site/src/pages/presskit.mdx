...
<Image src="titleWithByline" alt="wildfire swap title with byline" />

<Image src="titleWhite" alt="wildfire swap title in white" />

<Image
  src="titleWithBylineWhite"
  alt="wildfire swap title in white with byline"
/>
